...
public class CustomerDAOImpl implements CustomerDAO {
    ...
    private static final String SELECT_A_FROM_CUSTOMER_A = "Select a From Customer a ORDER BY a.name";
    ...
    private static final String FROM_CUSTOMER_S_WHERE_S_PRICE_GROUP_ID_IDPRICEGR_AND_S_TYPE_OF_CUSTOMER_ID_IDTYPEOFCUST = "from Customer s where s.priceGroup.id = :idpricegr and s.typeOfCustomer.id =:idtypeofcust";
    ...
    public List<Customer> getCustomers(long priceGroupId, long typeOfCustomerId) {
        Session session = sessionFactory.getCurrentSession();
        return session.createQuery(FROM_CUSTOMER_S_WHERE_S_PRICE_GROUP_ID_IDPRICEGR_AND_S_TYPE_OF_CUSTOMER_ID_IDTYPEOFCUST, Customer.class)
                .setParameter("idpricegr", priceGroupId)
                .setParameter("idtypeofcust", typeOfCustomerId)
                .getResultList();
    }
