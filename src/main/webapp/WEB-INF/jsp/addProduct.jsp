...
<nav class="navbar navbar-default" style="background-color: firebrick">
    <div class="container-fluid">
        ...
        <ul class="nav navbar-nav">
            ...
            <li class="dropdown active"><a class="dropdown-toggle" style="color: white" data-toggle="dropdown" href="#">Products<span
                    class="caret"></span></a>
                <ul class="dropdown-menu">
...
<form:form modelAttribute="product" method="POST" cssClass="table-bordered rounded" class="form-horizontal"
           cssStyle="margin: 100px;">
